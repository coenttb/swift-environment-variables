...
extension EnvironmentVariables {
    ...
    fileprivate var httpsRedirect: Bool? {
...
extension EnvironmentVariables {
    fileprivate var allowedHosts: [String]? {
        get {
            self["ALLOWED_HOSTS"]?
...
struct ReadmeVerificationTests {
    ...
    func testProjectRootConfigExample() throws {
        ...
        let devEnv = """
            ...
            """
        try devEnv.write(
            to: tempDir.appendingPathComponent(".env.development"),
            atomically: true,
            encoding: .utf8
        )
    ...
    func testErrorTypesExample() throws {
        ...
        let _: EnvironmentVariables.LiveError = .initializationFailed(
